...
Record convertChunkToRecord(const std::array<uint8_t, CHUNK_SIZE_IN_BYTE> &chunk, const std::array<int, 4> &offset, const std::array<float, 4> &gain, const std::array<float, 4> &transmission)
{
    size_t count = 0;
