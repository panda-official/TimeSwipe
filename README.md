...
<br />
	...
	•	atsame5 chip-erase : the former command only erases one sector. To erase the whole flash, use this command (the <br />
		only command in this list which does not require reset_init) <br />
